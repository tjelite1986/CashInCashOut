...
public final class DialogAddPriceBinding implements ViewBinding {
  @NonNull
  ...
  private DialogAddPriceBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull LinearLayout layoutCampaignPrice, @NonNull Spinner spinnerStore,
      @NonNull SwitchMaterial switchCampaignPrice) {
  ...
  @NonNull
  public static DialogAddPriceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogAddPriceBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_add_price, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogAddPriceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddPriceBinding((LinearLayout) rootView, editTextCampaignPrice,
          editTextCampaignQuantity, editTextPrice, layoutCampaignPrice, spinnerStore,
          switchCampaignPrice);
    }
