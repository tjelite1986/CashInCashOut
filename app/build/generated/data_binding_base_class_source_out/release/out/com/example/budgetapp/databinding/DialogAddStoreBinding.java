...
public final class DialogAddStoreBinding implements ViewBinding {
  ...
  @NonNull
  public final AutoCompleteTextView acStoreChain;
  ...
  private DialogAddStoreBinding(@NonNull LinearLayout rootView,
      @NonNull AutoCompleteTextView acStoreChain, @NonNull MaterialButton btnCancel,
    ...
    this.acStoreChain = acStoreChain;
  ...
  public static DialogAddStoreBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.acStoreChain;
      AutoCompleteTextView acStoreChain = ViewBindings.findChildViewById(rootView, id);
      if (acStoreChain == null) {
        break missingId;
      }
      ...
      return new DialogAddStoreBinding((LinearLayout) rootView, acStoreChain, btnCancel, btnSave,
          etStoreAddress, etStoreCity, etStoreName, tilStoreAddress, tilStoreChain, tilStoreCity,
          tilStoreName);
    }
