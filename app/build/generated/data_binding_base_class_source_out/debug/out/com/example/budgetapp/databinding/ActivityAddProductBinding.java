...
public final class ActivityAddProductBinding implements ViewBinding {
  ...
  private ActivityAddProductBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull MaterialButton buttonScanBarcode, @NonNull TextInputEditText editTextAmount,
      @NonNull TextInputEditText editTextBarcode, @NonNull TextInputEditText editTextCampaignPrice,
  ...
  public static ActivityAddProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddProductBinding((CoordinatorLayout) rootView, buttonCancel, buttonSave,
          ...
          spinnerCategory, spinnerStore, spinnerUnit, switchCampaignPrice, switchDeposit, toolbar);
    }
