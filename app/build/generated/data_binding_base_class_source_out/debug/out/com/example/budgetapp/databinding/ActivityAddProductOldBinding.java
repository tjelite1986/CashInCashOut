...
public final class ActivityAddProductOldBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAddProductOldBinding(@NonNull ScrollView rootView, @NonNull Button buttonCancel,
      ...
      @NonNull Spinner spinnerStore, @NonNull Spinner spinnerUnit,
      @NonNull SwitchMaterial switchCampaignPrice, @NonNull SwitchMaterial switchDeposit) {
  ...
  @NonNull
  public static ActivityAddProductOldBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAddProductOldBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_add_product_old, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAddProductOldBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Spinner spinnerStore = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityAddProductOldBinding((ScrollView) rootView, buttonCancel, buttonSave,
          ...
          spinnerCategory, spinnerStore, spinnerUnit, switchCampaignPrice, switchDeposit);
    }
