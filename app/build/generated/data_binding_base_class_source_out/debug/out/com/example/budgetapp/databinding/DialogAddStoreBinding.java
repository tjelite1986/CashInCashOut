...
public final class DialogAddStoreBinding implements ViewBinding {
  @NonNull
  ...
  private DialogAddStoreBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnCancel,
      @NonNull MaterialButton btnSave, @NonNull TextInputEditText etStoreAddress,
      @NonNull TextInputEditText etStoreChain, @NonNull TextInputEditText etStoreCity,
      @NonNull TextInputEditText etStoreName, @NonNull TextInputLayout tilStoreAddress,
      @NonNull TextInputLayout tilStoreChain, @NonNull TextInputLayout tilStoreCity,
      @NonNull TextInputLayout tilStoreName) {
  ...
  @NonNull
  public static DialogAddStoreBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogAddStoreBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_add_store, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogAddStoreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddStoreBinding((LinearLayout) rootView, btnCancel, btnSave, etStoreAddress,
          etStoreChain, etStoreCity, etStoreName, tilStoreAddress, tilStoreChain, tilStoreCity,
          tilStoreName);
    }
