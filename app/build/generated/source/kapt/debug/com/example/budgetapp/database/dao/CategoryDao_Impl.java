...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `categories` (`id`,`name`,`color`,`iconName`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfCategory = new EntityDeletionOrUpdateAdapter<Category>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`name` = ?,`color` = ?,`iconName` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object deleteCategoryById(final long id, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Category(_tmpId,_tmpName,_tmpColor,_tmpIconName);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Category call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Category(_tmpId,_tmpName,_tmpColor,_tmpIconName);
          } else {
            _result = null;
          }
          return _result;
